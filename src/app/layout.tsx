    ...
    <html lang="en">
      ...
      >
        ...
        <div className="min-h-screen flex flex-col relative z-10">
          <header className="bg-gradient-to-r from-gray-900 to-gray-800 text-white shadow-lg relative z-20">
          ...
          <footer className="bg-gray-900 text-gray-400 py-8 relative z-20">
